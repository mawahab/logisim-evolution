    ...
    if (_notEquals) {
      Integer _xblockexpression = null;
      {
        ...
        if (_greaterThan_1) {
          ...
          throw new RuntimeException(_plus_15);
        }
        ...
        int _ub_4 = _range_11.getUb();
        Range _range_12 = b.getRange();
        int _lb_6 = _range_12.getLb();
        int _minus_4 = (_ub_4 - _lb_6);
        int _plus_20 = (_minus_4 + 1);
        _xblockexpression = this.typeMap.put(b, Integer.valueOf(_plus_20));
      }
