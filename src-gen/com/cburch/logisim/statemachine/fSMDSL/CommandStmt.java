...
public interface CommandStmt extends TOP
{
   ...
   * The list contents are of type {@link com.cburch.logisim.statemachine.fSMDSL.ShortInput}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @generated
   */
  EList<ShortInput> getIn();

  /**
   * Returns the value of the '<em><b>Out</b></em>' containment reference list.
   * The list contents are of type {@link com.cburch.logisim.statemachine.fSMDSL.ShortOutput}.
   * <!-- begin-user-doc -->
   * <p>
