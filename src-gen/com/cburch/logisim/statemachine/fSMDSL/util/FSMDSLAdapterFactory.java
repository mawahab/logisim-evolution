...
public class FSMDSLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FSMDSLSwitch<Adapter> modelSwitch =
    new FSMDSLSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseShortInput(ShortInput object)
      {
        return createShortInputAdapter();
      }
      @Override
      public Adapter caseShortOutput(ShortOutput object)
      {
        return createShortOutputAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.cburch.logisim.statemachine.fSMDSL.ShortInput <em>Short Input</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createShortInputAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link com.cburch.logisim.statemachine.fSMDSL.ShortOutput <em>Short Output</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createShortOutputAdapter()
  {
    return null;
  }
