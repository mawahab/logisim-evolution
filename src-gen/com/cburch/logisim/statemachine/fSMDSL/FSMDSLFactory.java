...
public interface FSMDSLFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Short Input</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Short Input</em>'.
   * @generated
   */
  ShortInput createShortInput();

  /**
   * Returns a new object of class '<em>Short Output</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Short Output</em>'.
   * @generated
   */
  ShortOutput createShortOutput();
