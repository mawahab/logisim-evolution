...
public class bin2sevensegHDLGeneratorFactory extends AbstractHDLGeneratorFactory{
	...
	public ArrayList<String> GetModuleFunctionality(Netlist TheNetlist,
		...
		Contents.add("   ");
		Contents.add("   MakeSegs : PROCESS( Din )");
		Contents.add("   BEGIN");
		Contents.add("      CASE (Din) IS");
	...
	public SortedMap<String, String> GetPortMap(Netlist Nets,
		...
		PortMap.putAll(GetNetMap("Din",true,ComponentInfo,bin2sevenseg.Din,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_a",true,ComponentInfo,bcd2sevenseg.Segment_A,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_b",true,ComponentInfo,bcd2sevenseg.Segment_B,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_c",true,ComponentInfo,bcd2sevenseg.Segment_C,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_d",true,ComponentInfo,bcd2sevenseg.Segment_D,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_e",true,ComponentInfo,bcd2sevenseg.Segment_E,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_f",true,ComponentInfo,bcd2sevenseg.Segment_F,Reporter,HDLType,Nets));
		PortMap.putAll(GetNetMap("Segment_g",true,ComponentInfo,bcd2sevenseg.Segment_G,Reporter,HDLType,Nets));
		return PortMap;
	}
