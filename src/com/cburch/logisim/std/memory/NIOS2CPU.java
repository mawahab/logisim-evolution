...
public class NIOS2CPU {// extends Mem {
//
...
//
//		Port[] ps = new Port[5];
//		ps[CPU_ADDR] = new Port(0, 10, Port.INPUT, ADDR_ATTR);
//		ps[CPU_DOUT] = new Port(0, 10, Port.INPUT, ADDR_ATTR);
//		ps[CPU_DIN] = new Port(0, 10, Port.INPUT, ADDR_ATTR);
//		ps[IO_WR] = new Port(0, 10, Port.INPUT, ADDR_ATTR);
//		ps[IO_RD] = new Port(0, 10, Port.INPUT, ADDR_ATTR);
//		ps[IO_RR].setToolTip(Strings.getter("memAddrTip"));
...
//	}
//
//	CPUState getState(Instance instance, CircuitState state) {
//		 ret = () instance.getData(state);
//		if (ret == null) {
//			MemContents contents = instance
//					.getAttributeValue(NIOS2CPU.CONTENTS_ATTR);
//			ret = new (instance, contents, new MemListener(instance));
