...
public class NIOS2Instr {
	...
	public NIOS2Instr(long binaryInstruction) {
	...
	public static void main(String[] args) {
		NIOS2Instr test1 = new NIOS2Instr(0x18d1883a); // add r8,r3,r3
		System.out.println(test1);

		NIOS2Instr test2 = new NIOS2Instr(0x12806217); // ldw r10,392(r2)
		System.out.println(test2);

		NIOS2Instr test3 = new NIOS2Instr(0x80805215); // stw r2,328(r16)
